...
//   const history = useHistory();
  ...
  const handleSignUp = (e) => {
    ...
    //   history.push('/audio-preferences', { email: email, password: password, gender: gender, userName:userName });
	  navigate('/audio-preferences', { state:  { email: email, password: password, gender: gender, userName:userName } });
    }
    console.log({
      email,
      password,
