...
const Signup = () => {
  ...
  const handleSignUp = (e) => {
    e.preventDefault();
    const errors = validate(email, password, phoneNumber);
    if (Object.keys(errors).length !== 0) {
      setErrors(errors);
    } else {
      console.log("email: ", email, "password: ", password);
	  navigate('/audio-preferences', { state:  { email: email, password: password, gender: gender, userName:userName, phoneNumber:phoneNumber } });
    }
    console.log({
      email,
      password,
