...
from . import views
from .views import userManagement, NewUserSignup, EditProfileDetails, signInUser, singleDeviceLoginCheck
...
urlpatterns = [
    ...
    path('single-device-login-check/', singleDeviceLoginCheck.as_view(), name='edit-profile'),
]
